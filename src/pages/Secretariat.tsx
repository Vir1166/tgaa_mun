  ...
  const secretariesGenerals: TeamMember[] = [
    {
      ...
      bio: 'As Secretary-General of TGAAMUN 2.0, Samaira believes growth begins just beyond one’s comfort zone, echoing this year’s theme, Metamorphosis. After serving as Head of Public Relations for TGAAMUN 2025, she aims to create a conference that challenges delegates, broadens perspectives, and rewards bold thinking. A believer in empathy shaped through books and films (and Star Wars), she brings curiosity, conviction, and—by her Core OC’s account—a slightly dictatorial commitment to efficiency. She intends for TGAAMUN 2.0 to be rigorous, memorable, and never boring.',
    ...
    },
    {
      ...
      bio: 'As Deputy Secretary-General of TGAAMUN 2.0, Oas is committed to fostering a conference that is engaging, dynamic and memorable for every delegate. Passionate about communication and public speaking, she believes MUN is a space to exchange ideas, build confidence and form meaningful connections. Through TGAAMUN 2.0, she hopes to help create a conference that is intellectually enriching, smoothly executed and, above all, enjoyable for all.',
    ...
    },
    {
      ...
      bio: 'Liana Mathew, Director General of TGAAMUN 2.0, believes pressure creates diamonds and deadlines create motivation. A dedicated basketball lover, she knows the value of composure, confidence, and showing up when it matters most usually in the final 24 seconds. With high standards, strong opinions, and a slightly concerning love for crises, Liana is ready to keep delegates on their toes, test their limits, and ensure TGAAMUN 2.0 is anything but easy and everything but boring.',
  ...
  const delegateAffairs: TeamMember[] = [
    {
      ...
      bio: 'Vir Hariharan serves as the Head of Delegate Affairs for TGAAMUN 2.0, overseeing both the academic structure and digital backbone of the conference. He has worked on committees and agendas, coordinated study guides and matrices, and contributed to shaping the event’s academic direction. As the developer of the TGAAMUN website, he ensures a smooth and accessible experience for participants. His role combines technical execution with delegate-focused planning, emphasizing efficiency, clarity, and strong support throughout the MUN experience.',
  ...
  const designLayout: TeamMember[] = [
    {
      name: 'Alisha Gaikwad',
      role: 'Head of PR',
      bio: 'Alisha Gaikwad is the Head of Design and Layout for TGAAMUN \'26. Her role includes leading everything visual, including making posters, social media posts, decoration, and building a mood for the conference. Design sets the tone before the event begins, and her job is to make TGAAMUN\'26 look amazing from the start.',
    ...
    },
    {
      ...
      bio: 'Maghi Patil serves as the Head of Design and Layout for TGAAMUN\'26. Her role includes making posters, social media posts, decoration and building an aesthetic for the conference. Any event is judged first by its appearance, and her job is to make sure that the first impression is unforgettable.',
    ...
    },
    {
      name: 'Teesha Paul',
      role: 'Head of Design & Layout',
      bio: 'Teesha Paul is the Head of Design & Layout for TGAAMUN 2.0, responsible for creating a cohesive visual identity across all materials, from delegate kits to official documents. Her role focuses on ensuring everything is aesthetically strong and professionally aligned, proving that in MUN, presentation speaks before delegates do.',
